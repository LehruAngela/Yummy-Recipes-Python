...
def create_recipe_category(user_x):
    ...
    if request.method == 'POST':
        ...
        return redirect(url_for('add_recipes_to_category',
...
def add_recipes_to_category(num):
    ...
    if request.method == 'POST':
        ...
        return redirect(url_for('view_recipes', num=num))
    return render_template('addRecipesToCategory.html', username=user.username, title='Add recipes',
                           category_name=category_name)


@app.route('/recipeCategory/<num>/recipes')
def view_recipes(num):
